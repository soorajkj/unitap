...
export default function CreateHandle() {
  return (
    <Dialog.Root>
      <Dialog.Trigger render={<Button>Create Handle</Button>} />
      <Dialog.Portal>
        ...
        <Dialog.Popup className="-mt-8 -translate-x-1/2 -translate-y-1/2 fixed top-1/2 left-1/2 w-full max-w-96 rounded-lg bg-gray-50 p-6 text-gray-900 outline-1 outline-gray-200 transition-all duration-150 data-ending-style:scale-90 data-starting-style:scale-90 data-ending-style:opacity-0 data-starting-style:opacity-0 dark:outline-gray-300">
