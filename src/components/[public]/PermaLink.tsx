  ...
  return (
    <div className="grid grid-cols-1 gap-4">
      ...
      <div className="flex flex-wrap items-center justify-center gap-1">
        <Button className="relative inline-flex h-8 shrink cursor-pointer items-center justify-center gap-1 whitespace-nowrap rounded-lg border border-transparent px-2 py-2 text-base text-white leading-none transition hover:bg-stone-900 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 focus-visible:ring-offset-stone-950 disabled:pointer-events-none disabled:opacity-20 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 [&_svg]:text-stone-400">
