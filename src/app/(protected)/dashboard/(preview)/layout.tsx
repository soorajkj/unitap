...
export default function Layout({ children }: LayoutProps<"/dashboard">) {
  return (
    <div className="flex h-full flex-1 divide-x divide-neutral-200 overflow-hidden">
      <div className="scrollbar-none flex flex-1 flex-col divide-y divide-neutral-200 overflow-y-auto">
        <Header />
