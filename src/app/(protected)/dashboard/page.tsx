    ...
    <div className="grid gap-1 bg-stone-50">
      <div className="flex items-center gap-2 p-4 py-2 text-gray-500 text-sm">
        ...
        <div className="ml-auto flex items-center gap-4 text-xs">
          ...
          <span>
            Sentiment: <span className="font-semibold text-gray-900">2/14</span>{" "}
            <span className="text-green-500">▲</span>
          </span>
          <span>
            Position: <span className="font-semibold text-gray-900">5/14</span>{" "}
            <span className="text-green-500">▲</span>
          </span>
        </div>
      </div>
      <div className="grid grid-cols-12 gap-px overflow-hidden rounded-xl border border-neutral-200 bg-stone-200">
